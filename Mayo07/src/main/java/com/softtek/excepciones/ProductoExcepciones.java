...
@RestController
@ControllerAdvice
public class ProductoExcepciones extends ResponseEntityExceptionHandler {
    @Override
    ...
    public ResponseEntity<ExcepcionRespuesta> catchNoEncontrado(ExcepcionPersonalizadaNoEncontrada ex,WebRequest peticion){
